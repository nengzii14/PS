...
line = LINE("Er5FKZsZtqVnoL0i2qPf.F1wnY1P90Xd3CcqTvSoS7W.t1na6vYh8/mOLCRMFixWbsdONvcJjtiv0TEgjalMJvI=")
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [cName + " 📲ติดต่อเกี่ยวกับบอท :  line://ti/p/~nong1426"]
        ...
        if op.type == 15:
          if wait["Welcome"] == True:
            if op.param2 in admin:
                return
            cl.sendText(op.param1,"อ้าว... " + cl.getContact(op.param2).displayName +  " จะรีบไปไหน อยู่ส่องก่อนสิครับ😊")
